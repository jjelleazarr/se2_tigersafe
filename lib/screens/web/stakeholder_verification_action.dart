...
class ApplicationDeniedScreen extends StatelessWidget {
  ...
  const ApplicationDeniedScreen({super.key, required this.request});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            const Text(
              'Please make sure your submitted information is accurate. You may try again with corrected information.',
